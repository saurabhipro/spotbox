...
# See LICENSE file for full copyright and licensing details
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            "/spiffy_theme_backend/static/src/scss/list_view_row_filters.scss",
            ...
            "/spiffy_theme_backend/static/src/js/kanban_modal.js",
    ...
    'live_test_url': 'https://www.bizople.com/r/spiffy18-demo',
    'images': [
        'static/description/spiffy_cover.png',
        'static/description/spiffy_screenshot.gif',
        #'static/description/spiffy_offer_screenshot.jpg',
    ],
    'sequence': 1,
    'installable': True,
    'application': True,
